...
public class EiffelTypeIntervalImpl extends ASTWrapperPsiElement implements EiffelTypeInterval {

  public EiffelTypeIntervalImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EiffelVisitor visitor) {
    visitor.visitTypeInterval(this);
  }
