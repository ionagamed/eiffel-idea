...
public class EiffelActualGenericsImpl extends ASTWrapperPsiElement implements EiffelActualGenerics {

  public EiffelActualGenericsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EiffelVisitor visitor) {
    visitor.visitActualGenerics(this);
  }
