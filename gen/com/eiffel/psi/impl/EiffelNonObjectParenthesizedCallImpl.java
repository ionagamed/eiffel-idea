...
public class EiffelNonObjectParenthesizedCallImpl extends ASTWrapperPsiElement implements EiffelNonObjectParenthesizedCall {

  public EiffelNonObjectParenthesizedCallImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EiffelVisitor visitor) {
    visitor.visitNonObjectParenthesizedCall(this);
  }
