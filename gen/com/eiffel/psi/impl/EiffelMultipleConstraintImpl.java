...
public class EiffelMultipleConstraintImpl extends ASTWrapperPsiElement implements EiffelMultipleConstraint {

  public EiffelMultipleConstraintImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EiffelVisitor visitor) {
    visitor.visitMultipleConstraint(this);
  }
