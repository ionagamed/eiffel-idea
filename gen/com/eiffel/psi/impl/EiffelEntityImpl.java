...
public class EiffelEntityImpl extends ASTWrapperPsiElement implements EiffelEntity {

  public EiffelEntityImpl(ASTNode node) {
    super(node);
  }
  ...
  public EiffelVariable getVariable() {
    return PsiTreeUtil.getChildOfType(this, EiffelVariable.class);
  }
