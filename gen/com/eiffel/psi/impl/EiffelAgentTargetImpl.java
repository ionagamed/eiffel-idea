...
public class EiffelAgentTargetImpl extends ASTWrapperPsiElement implements EiffelAgentTarget {

  public EiffelAgentTargetImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EiffelVisitor visitor) {
    visitor.visitAgentTarget(this);
  }
  ...
  @Override
  @Nullable
  public EiffelEntity getEntity() {
    return PsiTreeUtil.getChildOfType(this, EiffelEntity.class);
  }
