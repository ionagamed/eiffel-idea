...
public class EiffelClassHeaderImpl extends ASTWrapperPsiElement implements EiffelClassHeader {

  public EiffelClassHeaderImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public EiffelHeaderMark getHeaderMark() {
    return PsiTreeUtil.getChildOfType(this, EiffelHeaderMark.class);
  }
