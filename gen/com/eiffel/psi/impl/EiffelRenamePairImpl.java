...
public class EiffelRenamePairImpl extends ASTWrapperPsiElement implements EiffelRenamePair {

  public EiffelRenamePairImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EiffelVisitor visitor) {
    visitor.visitRenamePair(this);
  }
